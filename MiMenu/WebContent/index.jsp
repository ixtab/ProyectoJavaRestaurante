...
<body>
	...
	<header class ="trans navbar-fixed">
			<nav>
			    <div class="teal darken-2 nav-wrapper">
			      <a href="http://localhost:8080/MiMenu/" class="brand-logo"><i class="large material-icons flow-text">local_dining</i> Mi Menú del día <i class="large material-icons right">local_dining</i></a>
	...
	<div class="trans margen-superior container row" id="contenedor">
		...
		<div id = "progreso" class="progress"><div class="indeterminate"></div></div>
